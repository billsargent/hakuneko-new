/**
 * This script ensures our customized files are correctly copied to the build directory
 * after the Polymer build process which might reorder or optimize our HTML.
 */
...
const files = [
    {
        ...
        target: 'build/web/lib/hakuneko/frontend@classic-dark/mangas.html'
    },
    {
        source: 'src/web/lib/hakuneko/frontend@classic-light/mangas.html',
        target: 'build/web/lib/hakuneko/frontend@classic-light/mangas.html'
    },
    {
        source: 'src/web/lib/hakuneko/frontend@classic-dark/mangas.html',
